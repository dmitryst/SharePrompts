...
To update the database use this command from the Web project folder (replace `SharePrompts` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../SharePrompts.Infrastructure/SharePrompts.Infrastructure.csproj -s SharePrompts.Web.csproj
```
